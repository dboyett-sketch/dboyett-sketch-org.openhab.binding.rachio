...
public class RachioHandlerFactory extends BaseThingHandlerFactory {
    ...
    // ===== CRITICAL PATCH: Corrected services for RachioBridgeHandler =====
    private final HttpClientFactory httpClientFactory;
    private final ScheduledExecutorService scheduler;
    // REMOVED: private final ThingHandlerCallback thingHandlerCallback;
     ...
     * @param scheduler Scheduled executor service (REQUIRED for BridgeHandler)
     */
    @Activate
    public RachioHandlerFactory(@Reference TranslationProvider translationProvider,
        ...
        // REMOVED: this.thingHandlerCallback = thingHandlerCallback;
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        try {
            if (RachioBindingConstants.THING_TYPE_BRIDGE.equals(thingTypeUID)) {
                // ===== CRITICAL PATCH: Match corrected RachioBridgeHandler constructor =====
    ...
    protected synchronized void removeHandler(ThingHandler thingHandler) {
        // Clean up any resources when handler is removed
